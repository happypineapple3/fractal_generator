...
import unittest 
from Mandelbrot import Mandelbrot, count
from Phoenix import Phoenix, count  	  
from Julia import Julia, count
from Spider import Spider, count
from BurningShip import BurningShip, count
